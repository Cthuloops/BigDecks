...
class CardsManager:
    ...
    def __init__(self):
        ...
        self.__log_file_path = self._get_log_file_path()
    ...
    def _get_log_file_path(self) -> str:
        ...
        return os.path.join(self.__instance_path, "log.txt")
            ...
            with open(self.__default_cards_path, "rb") as f:
                ...
                for card in ijson.items(f, "item", use_float=True):
                    ...
                    try:
                        ...
                        with open(self.__log_file_path, mode="a") as f:
                            f.write(f"[{datetime.now()}] {card.get("name")}"
                                    f", {card.get("id")}"
                                    f", {card.get("layout")}"
                                    f", {card.get("card_faces")}\n")
